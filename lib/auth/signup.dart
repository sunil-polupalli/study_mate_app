                ...
                child: Center(
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        // Signup Card - styled exactly like homepage cards
                        Container(
                          ...
                          child: Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                // Signup icon and title like homepage cards
                                Row(
                                  children: [
                                    Container(
                                      padding: EdgeInsets.all(12),
                                      decoration: BoxDecoration(
                                        color: Color(0xFF4A90E2), // Different color for signup
                                ...
                                // Signup Button - styled like homepage cards
                                Container(
                                  width: double.infinity,
                                  height: 55,
                                  decoration: BoxDecoration(
                                    color: Color(0xFF4A90E2), // Blue color like some homepage cards
                                    borderRadius: BorderRadius.circular(15),
                                    boxShadow: [
                                      BoxShadow(
